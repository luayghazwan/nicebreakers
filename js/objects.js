...
var scenariosArray = [
  ...
  //scenraio
  'Today is the first day of a new class and you are not sure if you are in the right room.  There is another person in the room, waiting for the instructor to arrive. Choose an action below that is closest to how you might approach that student.',
  ...
  //same order goes with all other scenarios
